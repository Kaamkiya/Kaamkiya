...
### misc
- pronouns: he/him
- wpm:      <!--S:MT_WPM-->73.3<!--E:MT_WPM--> with <!--S:MT_ACCURACY-->95.8<!--E:MT_ACCURACY-->% accuracy
  <!--duolingo: < !--S:DUO_XP--><!--E:DUO_XP--> <!--XP-->
- codewars: <!--S:CW_HONOR-->191<!--E:CW_HONOR--> honor
...
- prs opened:     <!--S:PRS_OPENED-->63<!--E:PRS_OPENED--> :inbox_tray:
