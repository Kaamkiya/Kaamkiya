...
### misc
- pronouns: he/him
- wpm:      <!--S:MT_WPM-->80.5<!--E:MT_WPM--> with <!--S:MT_ACCURACY-->97.0<!--E:MT_ACCURACY-->% accuracy
  <!--duolingo: < !--S:DUO_XP--><!--E:DUO_XP--> <!--XP-->
- codewars: <!--S:CW_HONOR-->137<!--E:CW_HONOR--> honor

### stats
- stars earned:   <!--S:STARS_EARNED-->52<!--E:STARS_EARNED--> :star:
- contributed to: <!--S:CONTRIBUTED_TO-->20<!--E:CONTRIBUTED_TO--> :handshake:
